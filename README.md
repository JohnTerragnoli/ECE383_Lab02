...
20. Then I noticed that the ch1 data was traveling off the right size of the oscilloscope.  I decided to check my logic in video and scopeface one more time to fix this.  I put row = 400 into the second channel was having the same phenomenon.  If this was the case, then scopeface would be the issue.  If not, it's coming from Lab02 logic somehow, even though this shouldn't be occuring.  
