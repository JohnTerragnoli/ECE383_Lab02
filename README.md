...
3. I then compiled the files successfully. I played a song from iTunes, but got nothing out of the ATLYS.  Checking the instantiation of the ac97, I remembered that I made an educated guess on the bus signals and decided to switch them.  I compiled everything again and found that music could play back through the loop.  It was a little staticy but nothing to worry about.  
4. Next I tackled the video instantiation, since I already knew that worked from lab1.  This job was just a copy and paste, including the two processes which take care of the button presses (all from lab1).  I had to change some signal names and such, but after I did this, everything worked smoothly.  I compiled and watched the grid image appear on the screen and double checked that my buttons worked the way I wanted them too.  The did on the first try (for once).  
...
7. I immediately started working on all of the logic sections I divided up at the beginning.  First up was the BRAM counter, since I felt like I could use my old counter to make this work.  I was able to do so, except I had to modify my cw(1 downto 0), which was sent from the control unit, to be accepted by my counter frame.  This involved turning the two bit control signal into two different one bit signals.  This was fairly easy.  I then declared and instantiated the BRAM_counter, and hooked up the 
