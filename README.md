...
16. I hooked up the logic analyzer to the three bits of the sw and cw signals. These were my observations: The cw seemed to be traveling through the states "storeSample" and "waitNextSample" multiple times.  However, this was not linked with the sw(2) signal.  sw(1) never occurs??  As for the sw(0) signal, it seems to be working right, because cw changes from "010" to "101" right after it occurs.  I then rechecked my code for what could be causing this.  
